...
namespace WpfAnimatedGif
{
    ...
    public static class ImageBehavior
    {
        ...
        public static readonly DependencyProperty IsInViewProperty =
            DependencyProperty.RegisterAttached("IsInView", typeof(bool), typeof(ImageBehavior), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.Inherits, (s, a) =>
            {
                Image i = s as Image;
                if (i != null)
                {
                    bool isInView = Convert.ToBoolean(a.NewValue);
                    var controller = GetAnimationController(i);
                    if (controller != null)
                    {
                        if (isInView)
                        {
        ...
        private static void InitAnimationOrImage(Image imageControl)
        {
            ...
            if (source != null && shouldAnimate && !isLoadingDeferred)
            {
                ...
                if (animation != null)
                {
                    ...
                    controller = new ImageAnimationController(imageControl, animation, GetIsInView(imageControl));
