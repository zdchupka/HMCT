...
{
    public class IsMessageThumbedUpByCurrentUserConverter : ConverterMarkupExtension<IsMessageThumbedUpByCurrentUserConverter>
    {
        public IsMessageThumbedUpByCurrentUserConverter()
        {
